!(function (e) {
  ...
  (i.prototype.init = function () {
    e("#basic-datepicker").flatpickr(),
      ...
      e("#range-datepicker").flatpickr({ mode: "range" }),
      e("#inline-datepicker").flatpickr({ inline: !0 }),
      ...
      e("#basic-colorpicker").colorpicker(),
      e("#hexa-colorpicker").colorpicker({ format: "auto" }),
      e("#component-colorpicker").colorpicker({ format: null }),
      e("#horizontal-colorpicker").colorpicker({ horizontal: !0 }),
      e("#inline-colorpicker").colorpicker({
        color: "#DD0F20",
        inline: !0,
        container: !0,
      }),
      e(".clockpicker").clockpicker({ donetext: "Done" }),
